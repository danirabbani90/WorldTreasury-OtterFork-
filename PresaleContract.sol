...
contract preTokenSales is Ownable {
    ...
    function setPreWorldTreasuryPrice(uint256 newPreWorldTreasuryPrice_)
        external
        onlyOwner
        returns (uint256)
    {
        presaleTokenPrice = newPreWorldTreasuryPrice_;
